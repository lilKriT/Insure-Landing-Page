  ...
  return (
    <section className="flex justify-center bg-darkViolet text-veryLightGray relative">
      <div className="container flex flex-col-reverse desktop:flex-row desktop:py-28 desktop:mx-6">
        {/* Left Column */}
        <div className="w-full desktop:w-1/2 flex flex-col justify-center items-center desktop:items-start text-center desktop:text-left gap-8 pr-4 mobile py-32 desktop:py-0 px-6 desktop:px-0 relative">
          ...
          <div className="absolute inset-0 pointer-events-none h-[125%] block desktop:hidden patternOverlayMobile"></div>
        </div>
        {/* Right Column */}
      ...
      <div className="absolute w-full pointer-events-none h-[150%] patternOverlay hidden desktop:block"></div>
    </section>
  );
};
